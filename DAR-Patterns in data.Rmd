...
```{r}
favstats(~pushups,data=pushups, groups=position)
```

The linemen have an interquartile range of ten while the skill players have an interquartile range of twenty-seven. The standard deviation for skill players (27.04) is larger than the standard deviation for linemen (9.74) which demonstrates that skill players have a larger spread. Since the skill players have a larger spread and a higher mean and median, the evidence is pointing towards skill players doing more pushups than linemen. 
