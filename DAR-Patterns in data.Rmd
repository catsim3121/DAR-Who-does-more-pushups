...
For numerical data, since we want to look at the relationship between the position and the amount of pushups the player can do it would be best to run a fav stats function to see the patterns in the two boxplots that I will create. 
