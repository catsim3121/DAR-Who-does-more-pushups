...
```{r}
CN <- ggplot(data = pushups,aes(x=position, y=pushups, color=position))
CN2 <- CN + geom_boxplot()
CN2 + ggtitle("Who does more pushups?")
```

By looking at the graph the linemen have a smaller spread than the skill players. They also have a smaller median than the skill players. The skill players boxplot has one outlier present. Based on the graph, skill players do more pushups than the linemen.
